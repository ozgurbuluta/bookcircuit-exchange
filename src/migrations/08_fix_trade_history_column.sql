-- Fix the update_trade_status function to use actor_id instead of user_id in trade_history
...
BEGIN
  ...
  IF v_current_user_id = v_initiator_id AND 
    ...
    -- Log action in trade history - Fix: changed user_id to actor_id
    INSERT INTO trade_history (
      trade_id,
      actor_id,  -- Changed from user_id to actor_id
      action,
      details
    ) VALUES (
      p_trade_id,
