-- Fix issues with book requests not being properly cancelled 
-- and issues with detecting request availability

-- Update the update_trade_status function to properly update book status when cancelling
...
-- Update create_direct_request to check for existing cancelled requests
